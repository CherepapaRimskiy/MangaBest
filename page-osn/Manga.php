...
<body>
    ...
    <div class="space">
        <div class="main">
            <div class="Zag-Main">Манга</div>
        </div>

        <div class="main2">
            <a href="../page-mang/chain/Chainsaw Man.php"><figure><img src="../img/3 (1).jpg" width="375px" height="500px" class="img-hov"><figcaption></figcaption></figure>
            
            <a href="../page-mang/JJBA.php"><figure><img src="../img/6.jpg" width="375px" height="500px" class="img-hov"><figcaption></figcaption></figure>
